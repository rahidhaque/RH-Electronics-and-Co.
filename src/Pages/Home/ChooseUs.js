            ...
            <div className="hero min-h-screen bg-base-200">
                <div className="hero-content flex-col lg:flex-row-reverse">
                    ...
                    <div>
                        ...
                        <p className="py-6 max-w-lg">Manufacturer’s high end manufacturing services are a perfect complement to today’s high tech industries. The manufacture of industrial equipment requires a vast knowledge base of processes. In producing computer parts we are reaching the scope of the industries.</p>
